...
// to calculate the size of the appointments array
int calculateTheAppointmentsArraySize(const struct Appointment* array, int maxAppointment);
...
// This will import patient data from file into a Patient array (returns # of records read)
int importPatients(const char* datafile, struct Patient patients[], int max);

// This will import appointment data from file into an Appointment array (returns # of records read)
